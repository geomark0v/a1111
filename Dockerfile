...
RUN wget -q -O models/checkpoints/cyberrealisticPony_v141_fp32.safetensors "https://huggingface.co/IgorGent/pony/resolve/main/cyberrealisticPony_v141 (1).safetensors?download=true"
...
RUN wget -q -O models/controlnet/ip-adapter-plus_sdxl_vit-h.safetensors "https://huggingface.co/IgorGent/pony/resolve/main/ip-adapter-plus_sdxl_vit-h (1).safetensors?download=true"
RUN wget -q -O models/controlnet/ip-adapter_sdxl_vit-h.safetensors "https://huggingface.co/IgorGent/pony/resolve/main/ip-adapter_sdxl_vit-h (1).safetensors?download=true"
...
RUN wget -q -O models/adetailer/Eyeful_v1.pt      "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/Eyeful_v1 (3).pt?download=true"
RUN wget -q -O models/adetailer/Eyes.pt           "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/Eyes (1) (2).pt?download=true"
RUN wget -q -O models/adetailer/Eyes_4.pt         "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/Eyes (4).pt?download=true"
RUN wget -q -O models/adetailer/FacesV1.pt        "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/FacesV1 (2).pt?download=true"
RUN wget -q -O models/adetailer/face_yolov8m.pt   "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/face_yolov8m (2).pt?download=true"
RUN wget -q -O models/adetailer/penis.pt          "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/penis (1) (2).pt?download=true"
RUN wget -q -O models/adetailer/penis_3.pt        "https://huggingface.co/IgorGent/pony/resolve/main/A-Detailer/penis (3).pt?download=true"
